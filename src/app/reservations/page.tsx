...
export default function Reservation(){
    return(
        <form>
        <main className="w-[100%] flex flex-col space-y-4 bg-white text-black-600 border border-gray-600
            font-semibold m-20 p-10 rounded-[5%] flex justify-center" >
            ...
            <br/>
                ...
                <div className="w-fit space space-y-2">
                ...
                <button type="submit" className="block rounded-md bg-sky-600 hover:bg-indigo-600 px-3 py-2 shadow-sm">
